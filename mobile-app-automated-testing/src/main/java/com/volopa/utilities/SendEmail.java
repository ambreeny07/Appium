...
public class SendEmail {
	...
	public static void SendEmailNow(String body) {
	        ...
	        try {
	            ...
	            message.setSubject("Vested Finance Android Automation Tests Run Report on "+currentDateTime);
	...
	public static void SendEmailNow(String body,String url) {
        ...
        try {
            ...
            String content="<br/><br/><a href='http://182.180.172.81:8082/Reports/Android/reports_1/reports/AndroidAutomationTestReport.html'>View on Dashboard</a><br/><br/><a href='"+url+"'>Click Here to Download Report</a>";
